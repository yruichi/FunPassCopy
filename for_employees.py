...
class EmployeeDashboard:
    ...
    def create_sidebar(self):
        ...
        # Sidebar buttons with icons (emojis)
    ...
    def show_dashboard(self):
        self.clear_content()
        # --- Modern Dashboard Title and Subtitle ---
...
"""
    ...
    def show_cancellations(self):
        ...
        # Add Cancellation Button (replaces Edit Status)
        add_btn = ctk.CTkButton(
    ...
    def show_pricing(self):
        ...
        # --- Pricing Table Card (no scrollable area) ---
        ...
        # Save/Reset Buttons and their frame are removed for employees (view only)
